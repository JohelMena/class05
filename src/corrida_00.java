...
*/
    public class corrida_00 {
        public static void main(String[] args) {
            ...
            System.out.println("ImpresiÃ³n de las excepciones mas comunes en Java.");
            ...
            try {
                ...
                System.out.println("ExcepciÃ³n aritmÃ©tica: " + e.getMessage());
            }
            ...
            try {
                ...
                System.out.println("ExcepciÃ³n por fuera de rango (vectores): " + e.getMessage());
            }
            ...
            try {
                ...
                System.out.println("ExcepciÃ³n por uso de Nulos: " + e.getMessage());
            }
            ...
            try {
                ...
                System.out.println("ExcepciÃ³n por formato de nÃºmero: " + e.getMessage());
            }
            ...
            try {
                ...
                System.out.println("ExcepciÃ³n por fuera de rango (texto): " + e.getMessage());
            }
            ...
            try {
                ...
                System.out.println("ExcepciÃ³n por conversiÃ³n de tipo: " + e.getMessage());
            }
            ...
            try {
                ...
                System.out.println("ExcepciÃ³n general: " + e.getMessage());
